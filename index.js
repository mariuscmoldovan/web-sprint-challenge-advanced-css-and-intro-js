...
function addArtist(array){
    ...
    let newArtist = { 
      id: 20,
      name: "Marius Moldovan", 
      years: 1984 - 2021, 
      genre: "Web Design", 
      nationality: "romanian",
      bio: "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquam explicabo omnis nesciunt voluptatibus voluptate, quia ratione nisi voluptas earum esse est pariatur ea distinctio nihil, id amet quam hic magni?"
    }  
...
function lotsOfArt(array){
  /*Your Code Here*/
let nameOfArtists100 = [];
for (let i = 0; i < array.length; i++) {
  if (array[i].paintings > 100) {
    nameOfArtists100.push(array[i].name)
  }
}
return nameOfArtists100;
}
